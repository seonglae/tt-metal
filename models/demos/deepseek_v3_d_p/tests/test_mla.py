...
def run_mla_inference(
    ...
    mla_tt = ttMLA(
        ...
        # Match the single-layer test cache (num_kvpe_cache_layers=1): the sparse write goes through
        # update_padded_kv_cache, which asserts cache_batch % layer_num == 0. Dense is unaffected (its
        # single-shot write uses fill_cache_for_user_, which ignores layer_num).
        layer_num=1,
