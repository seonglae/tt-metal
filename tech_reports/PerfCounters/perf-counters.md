...
The derived-metric catalogue (177 metrics, below) is shared between architectures; a metric whose counters exist on only one architecture reports N/A on the other.
